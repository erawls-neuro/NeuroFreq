...
if isstruct(dataX) == 1
    ...
    disp(['Recommended methods text: mixed-effects regression with ' ...
        'TFCE-corrected significance testing was conducted using routines ' ...
        'adapted from the ept-TFCE toolbox (Mensen & Khatami, 2013), with a ' ...
        'subject-level random intercept enforced.']);
